...
(function( $ ) {
	...
	$.fn.ghostHunter.defaults = {
		...
		onPageLoad			: false,
		onKeyUp				: false,
		result_template 	: "<a href={{link}} class='search-block__result'><div class='search-block__icon-container'><i class='search-block__icon icon-post'></i></div><div class='search-block__title'><strong class='search-block__text'>{{title}}</strong></div></a>",
		info_template		: "",
